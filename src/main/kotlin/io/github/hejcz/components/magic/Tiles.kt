...
interface MagicTile : BasicTile {
    ...
    private class MagicRotated90(tile: BasicTile) : TileRotated90(tile), MagicTile
    private class MagicRotated180(tile: BasicTile) : TileRotated180(tile), MagicTile
    private class MagicRotated270(tile: BasicTile) : TileRotated270(tile), MagicTile
}
...
object MaHeD : MagicTile, TileWithGreenFields by GreenFields(setOf(
    Location(Up),
    Location(Down)
)) {
    override fun exploreCastle(direction: Direction): Directions = direction.sameIfOneOf(
