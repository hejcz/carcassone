...
interface Tile : GreenFieldExplorable {
    fun exploreCastle(direction: Direction): Collection<io.github.hejcz.core.Direction>
    fun exploreRoad(direction: Direction): Collection<io.github.hejcz.core.Direction>
