...
data class Position(val x: Int, val y: Int) {
    ...
    fun relativeDirectionTo(other: Position) =
        relativePosition(Pair(x - other.x, y - other.y))
...
data class Location(val direction: Direction, val side: Side?) {
    ...
    fun left(): Location =
        Location(direction.left(), side)
    fun right(): Location =
        Location(direction.right(), side)
    fun mirrored(): Location =
        Location(direction.opposite(), side?.opposite())
    fun opposite(): Location =
        Location(direction.opposite(), side)
}
