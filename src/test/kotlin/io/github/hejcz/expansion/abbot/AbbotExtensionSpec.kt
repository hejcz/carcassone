    ...
    describe("Place") {
        ...
        it("should not be able to use Abbot as a knight") {
            GameScenario(singlePlayer(TileG, TileB))
                ...
                .thenReceivedEventShouldBe(InvalidPieceRoleEvent(AbbotPiece, Knight(Down)))
        }
        ...
        it("should not be able to use Abbot as a brigand") {
            GameScenario(singlePlayer(TileD, TileB))
                ...
                .thenReceivedEventShouldBe(InvalidPieceRoleEvent(AbbotPiece, Brigand(Left)))
        }
        ...
        it("should not be able to use Abbot as a peasant") {
            GameScenario(singlePlayer(TileB, TileD))
                ...
                .thenReceivedEventShouldBe(InvalidPieceRoleEvent(AbbotPiece, Peasant(Location(Down))))
        }
        ...
        it("should be able to pick Abbot instead of placing piece") {
            GameScenario(singlePlayer(TileEWithGarden, TileD, TileD))
                ...
                .thenReceivedEventShouldBe(ScoreEvent(1, 3, setOf(PieceOnBoard(Position(0, -1), AbbotPiece, Abbot))))
        }
        ...
        it("should be able to pick Abbot instead of placing piece") {
            GameScenario(singlePlayer(TileEWithGarden, TileD, TileD))
                ...
                .thenReceivedEventShouldBe(PieceEvent)
                .then(PickUpAbbotCmd(Position(0, -1)))
                .thenReceivedEventShouldBe(ScoreEvent(1, 2, setOf(PieceOnBoard(Position(0, -1), AbbotPiece, Abbot))))
        }
        ...
        it("should be able to pick Abbot instead of placing piece") {
            GameScenario(
                ...
                .thenReceivedEventShouldBe(PieceEvent)
                .then(PickUpAbbotCmd(Position(0, -1)))
                .thenReceivedEventShouldBe(ScoreEvent(1, 8, setOf(PieceOnBoard(Position(0, -1), AbbotPiece, Abbot))))
        }
