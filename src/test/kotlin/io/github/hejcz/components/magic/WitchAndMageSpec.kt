...
import io.github.hejcz.components.inn.tiles.TileEK
...
object WitchAndMageSpec : Spek({
    ...
    fun single(setup: (RemainingTiles) -> TestGameSetup, vararg tiles: BasicTile) =
        Game(
